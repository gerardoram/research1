...
public class IntentBarcodeFactoryTests extends ActivityInstrumentationTestCase2<BarCodeScannerActivity>
{
	...
	protected void setUp() throws Exception
	{
		...
		// Don't monitor the scanning activity, otherwise the test will stop on the second one
		getInstrumentation().addMonitor(new IntentFilter("com.hybris.mobile.SCAN"), null, true);
