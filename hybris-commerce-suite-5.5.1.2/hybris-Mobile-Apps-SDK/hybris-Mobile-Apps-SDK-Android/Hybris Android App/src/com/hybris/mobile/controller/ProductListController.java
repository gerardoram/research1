...
public class ProductListController extends Controller implements RESTLoaderObserver
{
	...
	public void getCategories(Category category)
	{
		...
		notifyOutboxHandlers(ProductListController.MESSAGE_MODEL_UPDATED, 0, 0, null);
	}
		...
		if (restLoaderResponse.getCode() == RESTLoaderResponse.SUCCESS)
		{
			...
			switch (webserviceEnumMethod)
			{
				...
				case METHOD_SPELLING_SUGGESTIONS:
					...
					notifyOutboxHandlers(ProductListController.MESSAGE_SEARCH_SUGGESTIONS, 0, 0, null);
