...
import com.hybris.mobile.activity.ProductListActivity;
	...
	public static boolean onOptionsItemSelected(MenuItem item, Activity activity)
	{
		...
		switch (item.getItemId())
		{
			case android.R.id.home:
				Intent intent = new Intent(activity, MainCategoriesActivity.class);
				intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				activity.startActivity(intent);
				activity.finish();
				return true;
			case R.id.refine:
				((ProductListActivity) activity).showFilter(null);
				return true;
			case R.id.cart:
