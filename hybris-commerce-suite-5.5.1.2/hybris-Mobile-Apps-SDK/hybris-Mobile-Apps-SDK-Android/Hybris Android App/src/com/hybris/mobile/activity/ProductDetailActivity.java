...
public class ProductDetailActivity extends HybrisActivity implements QuantityDialogListener, RESTLoaderObserver
{
				...
				case R.id.share:
					...
					try
					{
						...
						sendIntent.putExtra(
								...
								mProduct.getName()
										+ " - "
										+ getString(R.string.share_url, SDKSettings.getSettingValue(InternalConstants.KEY_PREF_BASE_URL),
												URLEncoder.encode(mProduct.getCode(), "UTF-8")));
