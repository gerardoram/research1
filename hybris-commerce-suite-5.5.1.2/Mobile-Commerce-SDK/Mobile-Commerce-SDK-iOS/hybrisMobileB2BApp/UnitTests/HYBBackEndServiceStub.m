...
- (id)init {
    ...
    costCenters = [converter sampleCostCenters];
...
- (void)costCentersForCurrentStoreAndExecute:(void (^)(NSArray *, NSError *))block {
    block(costCenters, nil);
}

- (void)setCostCenterWithCode:(NSString *)costCenterCode onCartWithCode:(NSString *)cartCode andExecute:(void (^)(HYBCart *, NSError *))block {
    block(cart, nil);
}
