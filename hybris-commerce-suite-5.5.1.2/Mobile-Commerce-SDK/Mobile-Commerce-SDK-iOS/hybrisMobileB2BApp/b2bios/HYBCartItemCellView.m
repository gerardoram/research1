...
- (void)loadWithItem:(HYBEntry *)item withProductImage:(UIImage *)itemImage {
    ...
    _productPriceLabel.text = item.basePriceFormattedValue;
    _totalPriceLabel.text   = item.totalPriceFormattedValue;
