...
- (void)openLogin {
    ...
    HYBLoginViewController *loginController = [[HYBLoginViewController alloc] initWithBackEndService:[self backEndService]];
    [[self getDelegate].window setRootViewController:loginController];
    [self clearSearch];
}
...
- (void)pushDetailControllerWithProduct:(HYBProduct *)product toggleDrawer:(BOOL)toggleDrawer {
    ...
    HYBProductDetailsController *detailViewController = [[HYBProductDetailsController alloc] initWithBackEndService:[self backEndService] productId:product.firstVariantCode];
