...
@property (nonatomic) HYBCategory *categoriesTree;
...
- (NSArray *)subcategoriesForCategory:(HYBCategory*)selectedCategory {
...
- (id)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(indexPath.row == 0) {
        ...
        HYBCategory *category = [_categories objectAtIndex:indexPath.row-1];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        ...
        HYBCategory *tappedCategory = [_categories objectAtIndex:indexPath.row - 1];
