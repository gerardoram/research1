...
- (void)loadCurrentCart {
    ...
    if (loadCart) {
        ...
        _mainView.orderSummaryView.subtotalValue.text = self.currentCart.subTotalFormatted;
        _mainView.orderSummaryView.taxValue.text = self.currentCart.totalTaxFormatted;
        _mainView.orderSummaryView.shippingValue.text = self.mode.formattedValue;
        _mainView.orderSummaryView.orderTotalValue.text = self.currentCart.totalPriceFormatted;
        
        if (self.currentCart.orderDiscounts.intValue > 0) {
            _mainView.orderSummaryView.savingsValue.text = self.currentCart.orderDiscountsFormattedValue;
            _mainView.orderSummaryView.savingsRecapTitle.text = self.currentCart.orderDiscountsMessage;
