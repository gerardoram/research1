...
- (void)loadAllProductImages {
    [self.b2bService loadImagesForProduct:_product
                                    block:^(NSMutableArray *fetchedImages, NSError *error) {
        if (error) {
            ...
            [_mainView displayProductsImages:[NSArray arrayWithArray:fetchedImages]];
        }
    }];
}
...
- (void)loadProduct {
    ...
    [self.b2bService findProductById:_code
