...
@property (nonatomic) HYBStore *currentStore;
...
- (void)getFullStore {
    if([self.geoObject hasOptions]) {
        ...
        [self.backEndService getStoreDetailWithStoreName:storeName andParams:nil andExecute:^(HYBStore *store, NSError *error) {
            if(error) {
...
- (void)finishSetupWithStore:(HYBStore*)store {
