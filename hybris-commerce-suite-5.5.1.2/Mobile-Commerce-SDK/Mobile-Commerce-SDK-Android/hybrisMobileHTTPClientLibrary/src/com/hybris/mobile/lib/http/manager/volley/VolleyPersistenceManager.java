...
public class VolleyPersistenceManager implements PersistenceManager {
    ...
    public VolleyPersistenceManager(Context applicationContext) {
        ...
        this.mQueue = newRequestQueueBackgroundThread(applicationContext.getApplicationContext());

        // Image loader using regular queue from Volley
        this.mImageLoader = new ImageLoader(Volley.newRequestQueue(applicationContext), new BitmapCache());
    }
     ...
     * @return Request to be dispatched
     */
    protected RequestQueue newRequestQueueBackgroundThread(Context context) {
     ...
     *
     * @see
     * com.hybris.mobile.lib.http.manager.PersistenceManager#execute(com.hybris.mobile.lib.http.response.DataResponseCallBack
     * , java.lang.String, java.lang.String, java.lang.String, java.util.Map, java.util.Map, boolean)
     */
    @Override
     ...
     * @param requestId            Unique request identifier
     * @param method               HTTP Methods : GET, PUT, POST, DELETE, UPDATE
