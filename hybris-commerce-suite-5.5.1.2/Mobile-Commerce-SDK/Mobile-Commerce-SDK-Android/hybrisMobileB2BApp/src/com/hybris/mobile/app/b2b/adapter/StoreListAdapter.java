...
import com.hybris.mobile.app.b2b.activity.StoreDetailsActivity;
import com.hybris.mobile.app.b2b.fragment.StoreListFragment;
import com.hybris.mobile.app.b2b.listener.DeviceLocation;
...
public class StoreListAdapter extends ArrayAdapter<Store> {
    ...
    public StoreListAdapter(Activity context, DeviceLocation deviceLocation, StoreListFragment.MapActions mapActions, List<Store> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            rowView.setTag(new ViewHolder(rowView, position));
        } else {
            rowView = convertView;
        }
    ...
    private void centerMap(Store store) {
        if (mMapActions != null) {
