...
public class CartProductListAdapter extends ArrayAdapter<OrderProduct> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (cartProduct != null) {
            ...
            if (StringUtils.isNotBlank(cartProduct.getProduct().getImageThumbnailUrl())) {
                B2BApplication.getContentServiceHelper().loadImage(cartProduct.getProduct().getImageThumbnailUrl(), null,
