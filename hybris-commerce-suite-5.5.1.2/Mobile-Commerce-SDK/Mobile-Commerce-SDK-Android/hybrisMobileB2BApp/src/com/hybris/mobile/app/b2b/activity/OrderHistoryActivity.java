...
public class OrderHistoryActivity extends MainActivity {
    ...
    protected void onResume() {
        ...
        if (intent != null && StringUtils.isNotBlank(intent.getStringExtra(SearchManager.QUERY))) {
            ...
            newIntent.putExtra(IntentConstants.ORDER_DETAIL_CODE, intent.getStringExtra(SearchManager.QUERY));
            newIntent.putExtra(IntentConstants.ORDER_DETAIL_FROM_SEARCH, true);
