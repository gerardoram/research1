...
public class OrderProductListAdapter extends ArrayAdapter<OrderProduct> {
    ...
    public OrderProductListAdapter(Activity context, List<OrderProduct> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final OrderProduct orderProduct = mProducts.get(position);
        if (orderProduct != null) {
            ...
            if (orderProduct.getPromotion() != null) {
                if (StringUtils.isNotBlank(orderProduct.getPromotion().getDescription())) {
                    orderViewHolder.productPromotion.setText(orderProduct.getPromotion().getDescription());
                }
            ...
            if (StringUtils.isNotBlank(orderProduct.getProduct().getImageThumbnailUrl())) {
                B2BApplication.getContentServiceHelper().loadImage(orderProduct.getProduct().getImageThumbnailUrl(), null,
