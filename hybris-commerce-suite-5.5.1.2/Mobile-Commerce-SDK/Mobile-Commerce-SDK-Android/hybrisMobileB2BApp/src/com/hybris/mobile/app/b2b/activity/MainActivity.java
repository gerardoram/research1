 ...
 */
public abstract class MainActivity extends ApplicationActivity {
    ...
    protected void onResume() {
        ...
        if (!B2BApplication.isOnline()) {
            ...
            Alert.show(this, configuration, getString(R.string.offline_status_top_nav, B2BApplication.getCatalogLastSyncDate()),
                    true);
        }
