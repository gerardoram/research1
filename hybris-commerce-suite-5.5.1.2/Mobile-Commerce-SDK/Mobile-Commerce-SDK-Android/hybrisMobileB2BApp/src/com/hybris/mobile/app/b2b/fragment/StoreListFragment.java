...
import com.hybris.mobile.app.b2b.adapter.StoreListAdapter;
...
public class StoreListFragment extends ListFragment implements DeviceLocation {
     ...
     */
    public static interface MapActions {
        /**
         * Method for callback
         */
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        // Setting the adapter
        mStoreListAdapter = new StoreListAdapter(getActivity(), this, mMapActions, new ArrayList<Store>());
