...
public class NetworkChangeBroadcastReceiver extends BroadcastReceiver
{
	...
	public void onReceive(Context context, Intent intent)
	{
		...
		if (B2BApplication.isOnlineStatusChanged(ConnectionUtils.isConnectedToInternet(context)))
		{
			// Save the online status
			B2BApplication.saveCurrentOnlineStatus(ConnectionUtils.isConnectedToInternet(context));
