...
public class Alert {
     ...
     * @param text          message to be displayed
     */
    private static void animIn(Context context, final Configuration configuration, final View alertView, TextView textView,
    ...
    private static ViewPropertyAnimator animViews(View alertView, final ViewGroup mainView, final Configuration configuration,
        ...
        if (configuration.isWithAnim()) {
            ...
            if (!configuration.isOverlayContent()) {
    ...
    public static class Configuration {
        ...
        public boolean isOverlayContent() {
