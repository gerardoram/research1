...
@IntegrationTest
public class HeroProducts_Tests extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("HeroProducts_Tests-log");
			robotSettings.setOutputName("HeroProducts_Tests-output");
			robotSettings.setReportName("HeroProducts_Tests-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20150313092124_commercesearch_artifact_release_5_5_1_2fd923e74cf513a21a5801b02e9fe7ee64386a93/prepare/build/source/commercesearchatddtests/genresources/robottests/HeroProducts_Tests.txt"));
		}
	...
	@Test
	public void Test_Heroes_Not_Applied_To_Sorts()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Heroes_Not_Applied_To_Sorts";
