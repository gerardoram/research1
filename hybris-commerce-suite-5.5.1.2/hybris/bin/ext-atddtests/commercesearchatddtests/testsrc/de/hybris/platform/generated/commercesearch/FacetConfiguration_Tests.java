 ...
 *
 */
package de.hybris.platform.generated.commercesearch;
...
@IntegrationTest
public class FacetConfiguration_Tests extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setOutputDir(new File(Config.getParameter("atddengine.report-path"), "commercesearch"));
			robotSettings.setLogName("FacetConfiguration_Tests-log");
			robotSettings.setOutputName("FacetConfiguration_Tests-output");
			robotSettings.setReportName("FacetConfiguration_Tests-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20150313092124_commercesearch_artifact_release_5_5_1_2fd923e74cf513a21a5801b02e9fe7ee64386a93/prepare/build/source/commercesearchatddtests/genresources/robottests/FacetConfiguration_Tests.txt"));
		}
	...
	@Test
	public void Should_Change_Facet_Order_By_Category()
	{
		modelService.detachAll();
		
		final String robotTestName = "Should_Change_Facet_Order_By_Category";
	...
	@Test
	public void Should_Make_Facet_Invisible_For_Global_Configuration()
	{
		modelService.detachAll();
		
		final String robotTestName = "Should_Make_Facet_Invisible_For_Global_Configuration";
	...
	@Test
	public void Should_Make_Facet_Visible_For_Global_Configuration()
	{
		modelService.detachAll();
		
		final String robotTestName = "Should_Make_Facet_Visible_For_Global_Configuration";
	...
	@Test
	public void Should_Make_Facet_Invisible_For_A_Given_Category()
	{
		modelService.detachAll();
		
		final String robotTestName = "Should_Make_Facet_Invisible_For_A_Given_Category";
	...
	@Test
	public void Should_Make_Facet_Visible_For_A_Given_Category()
	{
		modelService.detachAll();
		
		final String robotTestName = "Should_Make_Facet_Visible_For_A_Given_Category";
	...
	@Test
	public void Should_Retain_Category_Order_Config_When_Global_Facet_Order_Changed()
	{
		modelService.detachAll();
		
		final String robotTestName = "Should_Retain_Category_Order_Config_When_Global_Facet_Order_Changed";
	...
	@Test
	public void Should_Inherit_Category_Reconfiguration_From_Supercategory()
	{
		modelService.detachAll();
		
		final String robotTestName = "Should_Inherit_Category_Reconfiguration_From_Supercategory";
	...
	@Test
	public void Should_Overwrite_Inherited_Reconfigurations()
	{
		modelService.detachAll();
		
		final String robotTestName = "Should_Overwrite_Inherited_Reconfigurations";
	...
	@Test
	public void Should_Move_Facet_Below_Other_Facet_for_Category()
	{
		modelService.detachAll();
		
		final String robotTestName = "Should_Move_Facet_Below_Other_Facet_for_Category";
	...
	@Test
	public void Should_Move_Facet_Above_Other_Facet_for_Category()
	{
		modelService.detachAll();
		
		final String robotTestName = "Should_Move_Facet_Above_Other_Facet_for_Category";
	...
	@Test
	public void Should_Move_Facet_Above_Other_Facet_Globally()
	{
		modelService.detachAll();
		
		final String robotTestName = "Should_Move_Facet_Above_Other_Facet_Globally";
