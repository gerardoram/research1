...
@IntegrationTest
public class Boosting_Tests extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Boosting_Tests-log");
			robotSettings.setOutputName("Boosting_Tests-output");
			robotSettings.setReportName("Boosting_Tests-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20150313092124_commercesearch_artifact_release_5_5_1_2fd923e74cf513a21a5801b02e9fe7ee64386a93/prepare/build/source/commercesearchatddtests/genresources/robottests/Boosting_Tests.txt"));
		}
	...
	@Test
	public void Test_Boosting_By_InStock()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Boosting_By_InStock";
	...
	@Test
	public void Test_Boosting_By_Name()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Boosting_By_Name";
	...
	@Test
	public void Test_Boosting_By_Name_Via_Global()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Boosting_By_Name_Via_Global";
	...
	@Test
	public void Test_Boosting_By_Name_Via_Global_With_Overrides()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Boosting_By_Name_Via_Global_With_Overrides";
	...
	@Test
	public void Test_Boosting_Double_Type_Value_By_Average_Rating_And_Greater_Than_Or_Equal_To_Operator()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Boosting_Double_Type_Value_By_Average_Rating_And_Greater_Than_Or_Equal_To_Operator";
	...
	@Test
	public void Test_Boosting_Double_Type_Value_By_Average_Rating_And_Greater_Than_Operator()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Boosting_Double_Type_Value_By_Average_Rating_And_Greater_Than_Operator";
	...
	@Test
	public void Test_Boosting_Double_Type_Value_By_Average_Rating_And_Equal_To_Operator()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Boosting_Double_Type_Value_By_Average_Rating_And_Equal_To_Operator";
	...
	@Test
	public void Test_Boosting_Double_Type_Value_By_Average_Rating_And_Less_Or_Equal_To_Operator()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Boosting_Double_Type_Value_By_Average_Rating_And_Less_Or_Equal_To_Operator";
	...
	@Test
	public void Test_Boosting_Double_Type_Value_By_Average_Rating_And_Less_Than_Operator()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Boosting_Double_Type_Value_By_Average_Rating_And_Less_Than_Operator";
	...
	@Test
	public void Test_Boosting_By_Contains_Operator()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Boosting_By_Contains_Operator";
