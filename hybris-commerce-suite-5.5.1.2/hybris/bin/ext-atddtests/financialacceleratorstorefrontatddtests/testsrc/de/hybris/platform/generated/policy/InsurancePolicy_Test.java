 ...
 *
 */
package de.hybris.platform.generated.policy;
...
@IntegrationTest
public class InsurancePolicy_Test extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setOutputDir(new File(Config.getParameter("atddengine.report-path"), "policy"));
			robotSettings.setLogName("InsurancePolicy_Test-log");
			robotSettings.setOutputName("InsurancePolicy_Test-output");
			robotSettings.setReportName("InsurancePolicy_Test-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/opt/bamboo-agent/xml-data/build-dir/HYM-IA1-JOB1/source/financialacceleratorstorefrontatddtests/genresources/robottests/InsurancePolicy_Test.txt"));
		}
	...
	@Test
	public void Test_Create_Insurance_Policy()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Create_Insurance_Policy";
