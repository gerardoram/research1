 ...
 *
 */
package de.hybris.platform.generated.agent;
...
@IntegrationTest
public class Agent_Test extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setOutputDir(new File(Config.getParameter("atddengine.report-path"), "agent"));
			robotSettings.setLogName("Agent_Test-log");
			robotSettings.setOutputName("Agent_Test-output");
			robotSettings.setReportName("Agent_Test-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/opt/bamboo-agent/xml-data/build-dir/HYM-IA1-JOB1/source/financialacceleratorstorefrontatddtests/genresources/robottests/Agent_Test.txt"));
		}
	...
	@Test
	public void Test_Agent_Loading_Via_UID()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Agent_Loading_Via_UID";
	...
	@Test
	public void Test_Agent_Has_Category()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Agent_Has_Category";
	...
	@Test
	public void Test_Agents_Loading_Via_CategoryCode()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Agents_Loading_Via_CategoryCode";
	...
	@Test
	public void Test_Agents_Loading_Via_CategoryCode_With_Checking()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Agents_Loading_Via_CategoryCode_With_Checking";
	...
	@Test
	public void Test_With_Unknown_Category()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_With_Unknown_Category";
	...
	@Test
	public void Test_Load_All_Agents()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Load_All_Agents";
