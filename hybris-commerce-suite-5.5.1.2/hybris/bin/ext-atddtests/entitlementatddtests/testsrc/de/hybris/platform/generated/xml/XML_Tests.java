 ...
 *
 */
package de.hybris.platform.generated.xml;
...
@IntegrationTest
public class XML_Tests extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setOutputDir(new File(Config.getParameter("atddengine.report-path"), "xml"));
			robotSettings.setLogName("XML_Tests-log");
			robotSettings.setOutputName("XML_Tests-output");
			robotSettings.setReportName("XML_Tests-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-ENT7-JOB1/source/entitlementatddtests/genresources/robottests/XML_Tests.txt"));
		}
	...
	@Test
	public void Test_Xml_Equal()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Xml_Equal";
	...
	@Test
	public void Test_Xml_Equal_Ignore_Id_Nodes()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Xml_Equal_Ignore_Id_Nodes";
