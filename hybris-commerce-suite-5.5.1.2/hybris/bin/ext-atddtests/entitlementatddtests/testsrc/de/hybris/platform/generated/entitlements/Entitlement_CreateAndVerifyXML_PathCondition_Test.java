...
@IntegrationTest
public class Entitlement_CreateAndVerifyXML_PathCondition_Test extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Entitlement_CreateAndVerifyXML_PathCondition_Test-log");
			robotSettings.setOutputName("Entitlement_CreateAndVerifyXML_PathCondition_Test-output");
			robotSettings.setReportName("Entitlement_CreateAndVerifyXML_PathCondition_Test-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-ENT7-JOB1/source/entitlementatddtests/genresources/robottests/Entitlement_CreateAndVerifyXML_PathCondition_Test.txt"));
		}
	...
	@Test
	public void Test_Entitlement_CreateAndVerifyXML_PathCondition_InvalidPath_No1_FAIL()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Entitlement_CreateAndVerifyXML_PathCondition_InvalidPath_No1_FAIL";
	...
	@Test
	public void Test_Entitlement_CreateAndVerifyXML_PathCondition_InvalidPath_No2_FAIL()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Entitlement_CreateAndVerifyXML_PathCondition_InvalidPath_No2_FAIL";
	...
	@Test
	public void Test_Entitlement_CreateAndVerifyXML_PathCondition_InvalidPath_No3_FAIL()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Entitlement_CreateAndVerifyXML_PathCondition_InvalidPath_No3_FAIL";
	...
	@Test
	public void Test_Entitlement_CreateAndVerifyXML_PathCondition_ValidPath_No1_PASS()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Entitlement_CreateAndVerifyXML_PathCondition_ValidPath_No1_PASS";
	...
	@Test
	public void Test_Entitlement_CreateAndVerifyXML_PathCondition_ValidPath_No2_PASS()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Entitlement_CreateAndVerifyXML_PathCondition_ValidPath_No2_PASS";
	...
	@Test
	public void Test_Entitlement_CreateAndVerifyXML_PathCondition_ValidPath_Long_PASS()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Entitlement_CreateAndVerifyXML_PathCondition_ValidPath_Long_PASS";
	...
	@Test
	public void Test_Entitlement_CreateAndVerifyXML_PathCondition_ValidPath_Short_PASS()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Entitlement_CreateAndVerifyXML_PathCondition_ValidPath_Short_PASS";
	...
	@Test
	public void Test_Entitlement_CreateAndVerifyXML_PathCondition_x2()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Entitlement_CreateAndVerifyXML_PathCondition_x2";
