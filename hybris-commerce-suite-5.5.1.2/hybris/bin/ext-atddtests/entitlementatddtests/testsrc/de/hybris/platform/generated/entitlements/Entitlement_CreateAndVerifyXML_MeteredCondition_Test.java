...
@IntegrationTest
public class Entitlement_CreateAndVerifyXML_MeteredCondition_Test extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Entitlement_CreateAndVerifyXML_MeteredCondition_Test-log");
			robotSettings.setOutputName("Entitlement_CreateAndVerifyXML_MeteredCondition_Test-output");
			robotSettings.setReportName("Entitlement_CreateAndVerifyXML_MeteredCondition_Test-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-ENT7-JOB1/source/entitlementatddtests/genresources/robottests/Entitlement_CreateAndVerifyXML_MeteredCondition_Test.txt"));
		}
	...
	@Test
	public void Test_Entitlement_CreateAndVerifyXML_MeteredCondition_x1()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Entitlement_CreateAndVerifyXML_MeteredCondition_x1";
	...
	@Test
	public void Test_Entitlement_CreateAndVerifyXML_MeteredCondition_x2()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Entitlement_CreateAndVerifyXML_MeteredCondition_x2";
	...
	@Test
	public void Test_Entitlement_CreateAndVerifyXML_MeteredCondition_Quantity_NoValue()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Entitlement_CreateAndVerifyXML_MeteredCondition_Quantity_NoValue";
	...
	@Test
	public void Test_Entitlement_CreateAndVerifyXML_MeteredCondition_Quantity_NonNumericValue_FAIL()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Entitlement_CreateAndVerifyXML_MeteredCondition_Quantity_NonNumericValue_FAIL";
	...
	@Test
	public void Test_Entitlement_CreateAndVerifyXML_MeteredCondition_Quantity_ZeroValue_PASS()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Entitlement_CreateAndVerifyXML_MeteredCondition_Quantity_ZeroValue_PASS";
