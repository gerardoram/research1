...
@IntegrationTest
public class Currency_Switch extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Currency_Switch-log");
			robotSettings.setOutputName("Currency_Switch-output");
			robotSettings.setReportName("Currency_Switch-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-SUB9-JOB1/source/subscriptionatddtests/genresources/robottests/Currency_Switch.txt"));
		}
	...
	@Test
	public void Test_Switch_Currency_One_SubscriptionProduct()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Switch_Currency_One_SubscriptionProduct";
	...
	@Test
	public void Test_Switch_Currency_Three_SubscriptionProducts()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Switch_Currency_Three_SubscriptionProducts";
	...
	@Test
	public void Test_Switch_Currency_Change_Xml()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Switch_Currency_Change_Xml";
