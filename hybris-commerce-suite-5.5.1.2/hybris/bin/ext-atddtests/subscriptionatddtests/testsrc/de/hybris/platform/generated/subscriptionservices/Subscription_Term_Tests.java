...
@IntegrationTest
public class Subscription_Term_Tests extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Subscription_Term_Tests-log");
			robotSettings.setOutputName("Subscription_Term_Tests-output");
			robotSettings.setReportName("Subscription_Term_Tests-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-SUB9-JOB1/source/subscriptionatddtests/genresources/robottests/Subscription_Term_Tests.txt"));
		}
	...
	@Test
	public void Test_Subscription_Terms_Default_For_Cancellable()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Subscription_Terms_Default_For_Cancellable";
	...
	@Test
	public void Test_Subscription_Terms_Not_Cancellable()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Subscription_Terms_Not_Cancellable";
	...
	@Test
	public void Test_Subscription_Terms_Custom_BillingPlan()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Subscription_Terms_Custom_BillingPlan";
