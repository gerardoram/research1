...
@IntegrationTest
public class XML_Verification_Usage_Charge_PerUnit_And_Volume extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("XML_Verification_Usage_Charge_PerUnit_And_Volume-log");
			robotSettings.setOutputName("XML_Verification_Usage_Charge_PerUnit_And_Volume-output");
			robotSettings.setReportName("XML_Verification_Usage_Charge_PerUnit_And_Volume-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-SUB9-JOB1/source/subscriptionatddtests/genresources/robottests/XML_Verification_Usage_Charge_PerUnit_And_Volume.txt"));
		}
	...
	@Test
	public void Test_XML_Verification_Usage_Charge_PerUnit_Overage_Video_Volume_Overage_Minute()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Usage_Charge_PerUnit_Overage_Video_Volume_Overage_Minute";
	...
	@Test
	public void Test_XML_Verification_Usage_Charge_PerUnit_Overage_Video_Volume_TierFrom1To2_Minute()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Usage_Charge_PerUnit_Overage_Video_Volume_TierFrom1To2_Minute";
	...
	@Test
	public void Test_XML_Verification_Usage_Charge_PerUnit_TierFrom1To2_Video_Volume_Overage_Minute()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Usage_Charge_PerUnit_TierFrom1To2_Video_Volume_Overage_Minute";
	...
	@Test
	public void Test_XML_Verification_Usage_Charge_PerUnit_TierFrom1To2_Video_Volume_TierFrom1To2_Minute()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Usage_Charge_PerUnit_TierFrom1To2_Video_Volume_TierFrom1To2_Minute";
	...
	@Test
	public void Test_XML_Verification_Usage_Charge_PerUnit_TierFrom1To2_From3To5_Video_Volume_TierFrom1To2_From3To9_Minute()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Usage_Charge_PerUnit_TierFrom1To2_From3To5_Video_Volume_TierFrom1To2_From3To9_Minute";
	...
	@Test
	public void Test_XML_Verification_Usage_Charge_PerUnit_TierFrom1To2_From3To5_Video_Volume_TierFrom8To9_From10To10_Minute()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Usage_Charge_PerUnit_TierFrom1To2_From3To5_Video_Volume_TierFrom8To9_From10To10_Minute";
	...
	@Test
	public void Test_XML_Verification_Usage_Charge_PerUnit_Overage_TierFrom1To2_Video_Volume_TierFrom3To5_Minute()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Usage_Charge_PerUnit_Overage_TierFrom1To2_Video_Volume_TierFrom3To5_Minute";
	...
	@Test
	public void Test_XML_Verification_Usage_Charge_PerUnit_TierFrom1To2_Video_Volume_Overage_TierFrom3To5_Minute()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Usage_Charge_PerUnit_TierFrom1To2_Video_Volume_Overage_TierFrom3To5_Minute";
	...
	@Test
	public void Test_XML_Verification_Usage_Charge_PerUnit_Overage_TierFrom1To2_Video_Volume_Overage_TierFrom3To5_Minute()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Usage_Charge_PerUnit_Overage_TierFrom1To2_Video_Volume_Overage_TierFrom3To5_Minute";
