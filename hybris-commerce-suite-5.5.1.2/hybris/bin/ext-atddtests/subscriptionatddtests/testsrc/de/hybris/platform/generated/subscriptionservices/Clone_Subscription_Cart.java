...
@IntegrationTest
public class Clone_Subscription_Cart extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Clone_Subscription_Cart-log");
			robotSettings.setOutputName("Clone_Subscription_Cart-output");
			robotSettings.setReportName("Clone_Subscription_Cart-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-SUB9-JOB1/source/subscriptionatddtests/genresources/robottests/Clone_Subscription_Cart.txt"));
		}
	...
	@Test
	public void Clone_Child_Subscription_Cart_FAIL()
	{
		modelService.detachAll();
		
		final String robotTestName = "Clone_Child_Subscription_Cart_FAIL";
	...
	@Test
	public void Clone_Saved_Subscription_Cart()
	{
		modelService.detachAll();
		
		final String robotTestName = "Clone_Saved_Subscription_Cart";
