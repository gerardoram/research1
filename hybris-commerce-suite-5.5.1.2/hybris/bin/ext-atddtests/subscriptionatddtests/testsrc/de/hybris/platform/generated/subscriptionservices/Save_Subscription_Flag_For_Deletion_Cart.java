...
@IntegrationTest
public class Save_Subscription_Flag_For_Deletion_Cart extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Save_Subscription_Flag_For_Deletion_Cart-log");
			robotSettings.setOutputName("Save_Subscription_Flag_For_Deletion_Cart-output");
			robotSettings.setReportName("Save_Subscription_Flag_For_Deletion_Cart-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-SUB9-JOB1/source/subscriptionatddtests/genresources/robottests/Save_Subscription_Flag_For_Deletion_Cart.txt"));
		}
	...
	@Test
	public void Test_Flag_For_Deletion_Subscription_Cart_For_Subscription_Product()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Flag_For_Deletion_Subscription_Cart_For_Subscription_Product";
	...
	@Test
	public void Test_Flag_For_Deletion_Child_Cart()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Flag_For_Deletion_Child_Cart";
