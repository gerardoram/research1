...
@IntegrationTest
public class Cart_Query_MasterCart_Only extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Cart_Query_MasterCart_Only-log");
			robotSettings.setOutputName("Cart_Query_MasterCart_Only-output");
			robotSettings.setReportName("Cart_Query_MasterCart_Only-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-SUB9-JOB1/source/subscriptionatddtests/genresources/robottests/Cart_Query_MasterCart_Only.txt"));
		}
	...
	@Test
	public void Test_Cart_Query()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Cart_Query";
