...
@IntegrationTest
public class XML_Verification_Complex extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("XML_Verification_Complex-log");
			robotSettings.setOutputName("XML_Verification_Complex-output");
			robotSettings.setReportName("XML_Verification_Complex-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-SUB9-JOB1/source/subscriptionatddtests/genresources/robottests/XML_Verification_Complex.txt"));
		}
	...
	@Test
	public void Test_XML_Verification_Complex_Currency_USD()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Complex_Currency_USD";
	...
	@Test
	public void Test_XML_Verification_Complex_Currency_EUR()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Complex_Currency_EUR";
