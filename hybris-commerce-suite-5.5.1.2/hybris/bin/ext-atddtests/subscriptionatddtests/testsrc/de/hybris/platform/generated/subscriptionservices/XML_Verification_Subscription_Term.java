...
@IntegrationTest
public class XML_Verification_Subscription_Term extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("XML_Verification_Subscription_Term-log");
			robotSettings.setOutputName("XML_Verification_Subscription_Term-output");
			robotSettings.setReportName("XML_Verification_Subscription_Term-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-SUB9-JOB1/source/subscriptionatddtests/genresources/robottests/XML_Verification_Subscription_Term.txt"));
		}
	...
	@Test
	public void Test_XML_Verification_Subscription_Term_AutoRenewing_Monthly()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Subscription_Term_AutoRenewing_Monthly";
	...
	@Test
	public void Test_XML_Verification_Subscription_Term_AutoRenewing_Daily()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Subscription_Term_AutoRenewing_Daily";
	...
	@Test
	public void Test_XML_Verification_Subscription_Term_AutoRenewing_Weekly()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Subscription_Term_AutoRenewing_Weekly";
	...
	@Test
	public void Test_XML_Verification_Subscription_Term_NonRenewing_Daily()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Subscription_Term_NonRenewing_Daily";
	...
	@Test
	public void Test_XML_Verification_Subscription_Term_NonRenewing_Weekly()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Subscription_Term_NonRenewing_Weekly";
	...
	@Test
	public void Test_XML_Verification_Subscription_Term_RenewsOnce_Daily()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Subscription_Term_RenewsOnce_Daily";
	...
	@Test
	public void Test_XML_Verification_Subscription_Term_RenewsOnce_Weekly()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Subscription_Term_RenewsOnce_Weekly";
