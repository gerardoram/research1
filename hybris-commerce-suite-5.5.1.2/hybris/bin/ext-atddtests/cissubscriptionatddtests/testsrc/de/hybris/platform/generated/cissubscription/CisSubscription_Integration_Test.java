...
@IntegrationTest
public class CisSubscription_Integration_Test extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("CisSubscription_Integration_Test-log");
			robotSettings.setOutputName("CisSubscription_Integration_Test-output");
			robotSettings.setReportName("CisSubscription_Integration_Test-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-SUB9-JOB1/source/cissubscriptionatddtests/genresources/robottests/CisSubscription_Integration_Test.txt"));
		}
	...
	@Test
	public void Test_CisSubscription_Integration_Create_Subscription()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_CisSubscription_Integration_Create_Subscription";
