...
@IntegrationTest
public class CisSubscription_Populator_Test extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("CisSubscription_Populator_Test-log");
			robotSettings.setOutputName("CisSubscription_Populator_Test-output");
			robotSettings.setReportName("CisSubscription_Populator_Test-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-SUB9-JOB1/source/cissubscriptionatddtests/genresources/robottests/CisSubscription_Populator_Test.txt"));
		}
	...
	@Test
	public void Test_CisSubscription_Populator_BuyOneSubscriptionProductWithOneRecurringPriceConverter()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_CisSubscription_Populator_BuyOneSubscriptionProductWithOneRecurringPriceConverter";
	...
	@Test
	public void Test_CisSubscription_Populator_BuyOneSubscriptionProductWithTwoRecurringPricesPayOnFirstBillConverter()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_CisSubscription_Populator_BuyOneSubscriptionProductWithTwoRecurringPricesPayOnFirstBillConverter";
	...
	@Test
	public void Test_CisSubscription_Populator_BuyOneSubscriptionProductWithTwoRecurringPricesPayOnFirstBillNoMergeConverter()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_CisSubscription_Populator_BuyOneSubscriptionProductWithTwoRecurringPricesPayOnFirstBillNoMergeConverter";
	...
	@Test
	public void Test_CisSubscription_Populator_BuyOneSubscriptionProductWithTwoRecurringPricesPayOnFirstBillNoSplitConverter()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_CisSubscription_Populator_BuyOneSubscriptionProductWithTwoRecurringPricesPayOnFirstBillNoSplitConverter";
	...
	@Test
	public void Test_CisSubscription_Populator_BuyOneSubscriptionProductWithTwoRecurringPricesPayOnFirstBillNoBigSplitConverter()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_CisSubscription_Populator_BuyOneSubscriptionProductWithTwoRecurringPricesPayOnFirstBillNoBigSplitConverter";
	...
	@Test
	public void Test_CisSubscription_Populator_BuyOneSubscriptionProductWithThreeRecurringPricesConverter()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_CisSubscription_Populator_BuyOneSubscriptionProductWithThreeRecurringPricesConverter";
	...
	@Test
	public void Test_CisSubscription_Populator_BuyOneSubscriptionProductWithOneRecurringPriceAndPayNowConverter()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_CisSubscription_Populator_BuyOneSubscriptionProductWithOneRecurringPriceAndPayNowConverter";
