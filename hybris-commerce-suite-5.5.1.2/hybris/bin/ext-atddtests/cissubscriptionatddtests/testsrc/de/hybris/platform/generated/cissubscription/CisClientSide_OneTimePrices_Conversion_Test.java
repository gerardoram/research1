...
@IntegrationTest
public class CisClientSide_OneTimePrices_Conversion_Test extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("CisClientSide_OneTimePrices_Conversion_Test-log");
			robotSettings.setOutputName("CisClientSide_OneTimePrices_Conversion_Test-output");
			robotSettings.setReportName("CisClientSide_OneTimePrices_Conversion_Test-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-SUB9-JOB1/source/cissubscriptionatddtests/genresources/robottests/CisClientSide_OneTimePrices_Conversion_Test.txt"));
		}
	...
	@Test
	public void Test_CisClientSide_OneTimePrices_Conversion_Onfirstbill()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_CisClientSide_OneTimePrices_Conversion_Onfirstbill";
	...
	@Test
	public void Test_CisClientSide_OneTimePrices_Conversion_Paynow()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_CisClientSide_OneTimePrices_Conversion_Paynow";
	...
	@Test
	public void Test_CisClientSide_OneTimePrices_Conversion_Onfirstbill_Paynow()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_CisClientSide_OneTimePrices_Conversion_Onfirstbill_Paynow";
