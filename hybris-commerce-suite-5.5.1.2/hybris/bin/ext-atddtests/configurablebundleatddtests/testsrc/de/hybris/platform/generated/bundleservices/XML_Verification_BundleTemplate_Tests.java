...
@IntegrationTest
public class XML_Verification_BundleTemplate_Tests extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("XML_Verification_BundleTemplate_Tests-log");
			robotSettings.setOutputName("XML_Verification_BundleTemplate_Tests-output");
			robotSettings.setReportName("XML_Verification_BundleTemplate_Tests-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/opt/bamboo-agent/xml-data/build-dir/HYM-BUNDLE10-JOB1/source/configurablebundleatddtests/genresources/robottests/XML_Verification_BundleTemplate_Tests.txt"));
		}
	...
	@Test
	public void Test_XML_Verification_Product_Bundle_Template()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Product_Bundle_Template";
	...
	@Test
	public void Test_XML_Verification_Bundle_Disable_Rule_Target_Product()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Bundle_Disable_Rule_Target_Product";
	...
	@Test
	public void Test_XML_Verification_Bundle_Disable_Rule_Conditional_Product()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Bundle_Disable_Rule_Conditional_Product";
	...
	@Test
	public void Test_XML_Verification_Potential_Product_Lower_Limit()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Potential_Product_Lower_Limit";
	...
	@Test
	public void Test_XML_Verification_Potential_Product_Upper_Limit()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Potential_Product_Upper_Limit";
	...
	@Test
	public void Test_XML_Verification_Potential_Product_Disable_Rule()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Potential_Product_Disable_Rule";
