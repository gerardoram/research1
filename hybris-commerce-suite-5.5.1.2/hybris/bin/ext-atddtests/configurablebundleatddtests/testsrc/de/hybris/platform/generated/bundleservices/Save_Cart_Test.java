...
@IntegrationTest
public class Save_Cart_Test extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Save_Cart_Test-log");
			robotSettings.setOutputName("Save_Cart_Test-output");
			robotSettings.setReportName("Save_Cart_Test-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/opt/bamboo-agent/xml-data/build-dir/HYM-BUNDLE10-JOB1/source/configurablebundleatddtests/genresources/robottests/Save_Cart_Test.txt"));
		}
	...
	@Test
	public void Clear_LastModifiedEntries_On_Clone_Test()
	{
		modelService.detachAll();
		
		final String robotTestName = "Clear_LastModifiedEntries_On_Clone_Test";
