...
@IntegrationTest
public class Remove_From_Cart_Tests extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Remove_From_Cart_Tests-log");
			robotSettings.setOutputName("Remove_From_Cart_Tests-output");
			robotSettings.setReportName("Remove_From_Cart_Tests-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/opt/bamboo-agent/xml-data/build-dir/HYM-BUNDLE10-JOB1/source/configurablebundleatddtests/genresources/robottests/Remove_From_Cart_Tests.txt"));
		}
	...
	@Test
	public void Test_Remove_From_Cart_SingleBundle_SingleProduct()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Remove_From_Cart_SingleBundle_SingleProduct";
