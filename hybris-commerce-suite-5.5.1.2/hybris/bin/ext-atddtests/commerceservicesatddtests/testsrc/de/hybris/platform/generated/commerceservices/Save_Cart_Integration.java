...
@IntegrationTest
public class Save_Cart_Integration extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Save_Cart_Integration-log");
			robotSettings.setOutputName("Save_Cart_Integration-output");
			robotSettings.setReportName("Save_Cart_Integration-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20150312092626_commerceservices_artifact_release_5_5_1_3e84dad2fc09391fbbc78948cab9cc28c2830d2d/prepare/build/source/commerceservicesatddtests/genresources/robottests/Save_Cart_Integration.txt"));
		}
	...
	@Test
	public void Test_Save_Multiple_Carts_CustomerSessionCart_Then_Restore_And_Update()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Save_Multiple_Carts_CustomerSessionCart_Then_Restore_And_Update";
	...
	@Test
	public void Test_Save_Multiple_Carts_CustomerSessionCart_Then_Retrive_And_Update()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Save_Multiple_Carts_CustomerSessionCart_Then_Retrive_And_Update";
	...
	@Test
	public void Test_Save_Multiple_Carts_CustomerSessionCart_Then_Flag_For_Deletion()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Save_Multiple_Carts_CustomerSessionCart_Then_Flag_For_Deletion";
