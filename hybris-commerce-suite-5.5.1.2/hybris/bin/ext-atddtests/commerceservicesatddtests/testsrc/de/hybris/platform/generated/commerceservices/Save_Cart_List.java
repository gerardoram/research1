	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20150312092626_commerceservices_artifact_release_5_5_1_3e84dad2fc09391fbbc78948cab9cc28c2830d2d/prepare/build/source/commerceservicesatddtests/genresources/robottests/Save_Cart_List.txt"));
		}
