...
@IntegrationTest
public class Save_Cart_Details extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Save_Cart_Details-log");
			robotSettings.setOutputName("Save_Cart_Details-output");
			robotSettings.setReportName("Save_Cart_Details-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20150312092626_commerceservices_artifact_release_5_5_1_3e84dad2fc09391fbbc78948cab9cc28c2830d2d/prepare/build/source/commerceservicesatddtests/genresources/robottests/Save_Cart_Details.txt"));
		}
	...
	@Test
	public void Test_Save_Cart_Details_Retrieve_CartDetails_WrongCode()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Save_Cart_Details_Retrieve_CartDetails_WrongCode";
	...
	@Test
	public void Test_Save_Cart_Details_Retrieve_CartDetails_EmptyCode()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Save_Cart_Details_Retrieve_CartDetails_EmptyCode";
	...
	@Test
	public void Test_Save_Cart_Details_Retrieve_CartDetails_SingleCart()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Save_Cart_Details_Retrieve_CartDetails_SingleCart";
	...
	@Test
	public void Test_Save_Cart_Details_Retrieve_CartDetails_MultipleCarts()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Save_Cart_Details_Retrieve_CartDetails_MultipleCarts";
	...
	@Test
	public void Test_Save_Cart_Details_Retrieve_CartDetails_MultipleCustomers()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Save_Cart_Details_Retrieve_CartDetails_MultipleCustomers";
