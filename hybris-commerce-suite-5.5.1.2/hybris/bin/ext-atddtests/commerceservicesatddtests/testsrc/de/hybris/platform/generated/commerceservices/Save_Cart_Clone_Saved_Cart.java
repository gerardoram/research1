...
@IntegrationTest
public class Save_Cart_Clone_Saved_Cart extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Save_Cart_Clone_Saved_Cart-log");
			robotSettings.setOutputName("Save_Cart_Clone_Saved_Cart-output");
			robotSettings.setReportName("Save_Cart_Clone_Saved_Cart-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20150312092626_commerceservices_artifact_release_5_5_1_3e84dad2fc09391fbbc78948cab9cc28c2830d2d/prepare/build/source/commerceservicesatddtests/genresources/robottests/Save_Cart_Clone_Saved_Cart.txt"));
		}
	...
	@Test
	public void Test_Clone_Empty_Saved_Cart()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Clone_Empty_Saved_Cart";
	...
	@Test
	public void Test_Clone_Saved_Cart_With_Products()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Clone_Saved_Cart_With_Products";
	...
	@Test
	public void Test_Clone_Not_Saved_Cart_FAIL()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Clone_Not_Saved_Cart_FAIL";
	...
	@Test
	public void Test_Clone_Cart_Flagged_For_Deletion_FAIL()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Clone_Cart_Flagged_For_Deletion_FAIL";
	...
	@Test
	public void Test_Clone_Saved_Cart_Of_Different_User_FAIL()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Clone_Saved_Cart_Of_Different_User_FAIL";
