...
@IntegrationTest
public class EmsClientTest extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("EmsClientTest-log");
			robotSettings.setOutputName("EmsClientTest-output");
			robotSettings.setReportName("EmsClientTest-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-ENT7-JOB1/source/emsclientatddtests/genresources/robottests/EmsClientTest.txt"));
		}
	...
	@Test
	public void Test_Get_Grant()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Get_Grant";
