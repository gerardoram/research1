...
@IntegrationTest
public class Grant_Mapping_XML_Verification_MeteredCondition_Test extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Grant_Mapping_XML_Verification_MeteredCondition_Test-log");
			robotSettings.setOutputName("Grant_Mapping_XML_Verification_MeteredCondition_Test-output");
			robotSettings.setReportName("Grant_Mapping_XML_Verification_MeteredCondition_Test-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-ENT7-JOB1/source/emsclientatddtests/genresources/robottests/Grant_Mapping_XML_Verification_MeteredCondition_Test.txt"));
		}
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_MeteredCondition_MaxQuantity_123()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_MeteredCondition_MaxQuantity_123";
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_MeteredCondition_MaxQuantity_ZeroValue_PASS()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_MeteredCondition_MaxQuantity_ZeroValue_PASS";
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_MeteredCondition_MaxQuantity_MinusOneValue_PASS()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_MeteredCondition_MaxQuantity_MinusOneValue_PASS";
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_MeteredCondition_MaxQuantity_EmptyValue_FAIL()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_MeteredCondition_MaxQuantity_EmptyValue_FAIL";
