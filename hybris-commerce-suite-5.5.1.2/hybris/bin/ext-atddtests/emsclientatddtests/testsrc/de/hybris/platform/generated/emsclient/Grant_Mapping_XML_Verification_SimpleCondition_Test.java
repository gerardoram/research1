...
@IntegrationTest
public class Grant_Mapping_XML_Verification_SimpleCondition_Test extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Grant_Mapping_XML_Verification_SimpleCondition_Test-log");
			robotSettings.setOutputName("Grant_Mapping_XML_Verification_SimpleCondition_Test-output");
			robotSettings.setReportName("Grant_Mapping_XML_Verification_SimpleCondition_Test-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-ENT7-JOB1/source/emsclientatddtests/genresources/robottests/Grant_Mapping_XML_Verification_SimpleCondition_Test.txt"));
		}
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_SimpleCondition_NoGrantTime()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_SimpleCondition_NoGrantTime";
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_SimpleCondition_WithGrantTime()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_SimpleCondition_WithGrantTime";
