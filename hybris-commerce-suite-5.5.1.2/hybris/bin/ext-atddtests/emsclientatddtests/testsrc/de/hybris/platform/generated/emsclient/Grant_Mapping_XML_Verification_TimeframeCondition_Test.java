...
@IntegrationTest
public class Grant_Mapping_XML_Verification_TimeframeCondition_Test extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Grant_Mapping_XML_Verification_TimeframeCondition_Test-log");
			robotSettings.setOutputName("Grant_Mapping_XML_Verification_TimeframeCondition_Test-output");
			robotSettings.setReportName("Grant_Mapping_XML_Verification_TimeframeCondition_Test-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-ENT7-JOB1/source/emsclientatddtests/genresources/robottests/Grant_Mapping_XML_Verification_TimeframeCondition_Test.txt"));
		}
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_TimeframeCondition_TimeUnit_Day_No2()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_TimeframeCondition_TimeUnit_Day_No2";
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_TimeframeCondition_TimeUnit_Day_No3()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_TimeframeCondition_TimeUnit_Day_No3";
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_TimeframeCondition_TimeUnit_Day_No4()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_TimeframeCondition_TimeUnit_Day_No4";
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_TimeframeCondition_TimeUnit_Month_No2()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_TimeframeCondition_TimeUnit_Month_No2";
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_TimeframeCondition_TimeUnit_Month_No3()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_TimeframeCondition_TimeUnit_Month_No3";
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_TimeframeCondition_TimeUnit_Month_No4()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_TimeframeCondition_TimeUnit_Month_No4";
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_TimeframeCondition_Start_Zero_FAIL()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_TimeframeCondition_Start_Zero_FAIL";
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_TimeframeCondition_Start_Negative_FAIL()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_TimeframeCondition_Start_Negative_FAIL";
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_TimeframeCondition_Duration_Negative_FAIL()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_TimeframeCondition_Duration_Negative_FAIL";
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_TimeframeCondition_Duration_Zero_PASS()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_TimeframeCondition_Duration_Zero_PASS";
