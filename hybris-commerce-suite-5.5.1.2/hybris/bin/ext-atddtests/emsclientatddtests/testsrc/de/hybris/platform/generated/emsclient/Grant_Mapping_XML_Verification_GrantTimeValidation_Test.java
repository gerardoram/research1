...
@IntegrationTest
public class Grant_Mapping_XML_Verification_GrantTimeValidation_Test extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Grant_Mapping_XML_Verification_GrantTimeValidation_Test-log");
			robotSettings.setOutputName("Grant_Mapping_XML_Verification_GrantTimeValidation_Test-output");
			robotSettings.setReportName("Grant_Mapping_XML_Verification_GrantTimeValidation_Test-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-ENT7-JOB1/source/emsclientatddtests/genresources/robottests/Grant_Mapping_XML_Verification_GrantTimeValidation_Test.txt"));
		}
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_GrantTimeValidation_ValidGrantTime_No1_PASS()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_GrantTimeValidation_ValidGrantTime_No1_PASS";
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_GrantTimeValidation_ValidGrantTime_No2_PASS()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_GrantTimeValidation_ValidGrantTime_No2_PASS";
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_GrantTimeValidation_InvalidGrantTime_Month_FAIL()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_GrantTimeValidation_InvalidGrantTime_Month_FAIL";
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_GrantTimeValidation_InvalidGrantTime_Day_FAIL()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_GrantTimeValidation_InvalidGrantTime_Day_FAIL";
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_GrantTimeValidation_InvalidGrantTime_Hour_FAIL()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_GrantTimeValidation_InvalidGrantTime_Hour_FAIL";
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_GrantTimeValidation_InvalidGrantTime_Minute_FAIL()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_GrantTimeValidation_InvalidGrantTime_Minute_FAIL";
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_GrantTimeValidation_InvalidGrantTime_Second_FAIL()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_GrantTimeValidation_InvalidGrantTime_Second_FAIL";
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_GrantTimeValidation_InvalidGrantTime_TimeZone_FAIL()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_GrantTimeValidation_InvalidGrantTime_TimeZone_FAIL";
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_GrantTimeValidation_InvalidGrantTime_NonNumericValue_FAIL()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_GrantTimeValidation_InvalidGrantTime_NonNumericValue_FAIL";
