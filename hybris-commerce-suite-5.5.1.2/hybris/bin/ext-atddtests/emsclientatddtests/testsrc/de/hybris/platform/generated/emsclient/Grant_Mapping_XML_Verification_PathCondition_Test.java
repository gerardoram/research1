...
@IntegrationTest
public class Grant_Mapping_XML_Verification_PathCondition_Test extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Grant_Mapping_XML_Verification_PathCondition_Test-log");
			robotSettings.setOutputName("Grant_Mapping_XML_Verification_PathCondition_Test-output");
			robotSettings.setReportName("Grant_Mapping_XML_Verification_PathCondition_Test-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-ENT7-JOB1/source/emsclientatddtests/genresources/robottests/Grant_Mapping_XML_Verification_PathCondition_Test.txt"));
		}
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_PathCondition_ValidPath_No1_PASS()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_PathCondition_ValidPath_No1_PASS";
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_PathCondition_ValidPath_No2_PASS()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_PathCondition_ValidPath_No2_PASS";
	...
	@Test
	public void Test_Grant_Mapping_XML_Verification_PathCondition_Empty_PASS()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Grant_Mapping_XML_Verification_PathCondition_Empty_PASS";
