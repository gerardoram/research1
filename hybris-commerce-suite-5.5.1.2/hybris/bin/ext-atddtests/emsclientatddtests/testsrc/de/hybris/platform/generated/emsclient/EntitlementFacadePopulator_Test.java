...
@IntegrationTest
public class EntitlementFacadePopulator_Test extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("EntitlementFacadePopulator_Test-log");
			robotSettings.setOutputName("EntitlementFacadePopulator_Test-output");
			robotSettings.setReportName("EntitlementFacadePopulator_Test-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-ENT7-JOB1/source/emsclientatddtests/genresources/robottests/EntitlementFacadePopulator_Test.txt"));
		}
	...
	@Test
	public void Test_GrantEntitlement_AndCheckUserGrants_Simple()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_GrantEntitlement_AndCheckUserGrants_Simple";
