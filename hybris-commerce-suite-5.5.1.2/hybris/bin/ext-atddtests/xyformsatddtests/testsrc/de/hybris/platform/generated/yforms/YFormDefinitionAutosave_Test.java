...
@IntegrationTest
public class YFormDefinitionAutosave_Test extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("YFormDefinitionAutosave_Test-log");
			robotSettings.setOutputName("YFormDefinitionAutosave_Test-output");
			robotSettings.setReportName("YFormDefinitionAutosave_Test-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/opt/bamboo-agent/xml-data/build-dir/HYM-YF5-JOB1/source/xyformsatddtests/genresources/robottests/YFormDefinitionAutosave_Test.txt"));
		}
	...
	@Test
	public void Test_Get_Data_Record()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Get_Data_Record";
	...
	@Test
	public void Test_Get_Draft_Record()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Get_Draft_Record";
	...
	@Test
	public void Test_Save_Data_Record_Without_Previous_Draft_Record()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Save_Data_Record_Without_Previous_Draft_Record";
	...
	@Test
	public void Test_Save_Data_Record_With_Previous_Draft_Record()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Save_Data_Record_With_Previous_Draft_Record";
	...
	@Test
	public void Test_Save_Draft_Record_Without_Previous_Data_Record()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Save_Draft_Record_Without_Previous_Data_Record";
	...
	@Test
	public void Test_Save_Draft_Record_With_Previous_Data_Record()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Save_Draft_Record_With_Previous_Data_Record";
