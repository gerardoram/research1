...
@IntegrationTest
public class YFormDefinitionVersioning_Test extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("YFormDefinitionVersioning_Test-log");
			robotSettings.setOutputName("YFormDefinitionVersioning_Test-output");
			robotSettings.setReportName("YFormDefinitionVersioning_Test-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/opt/bamboo-agent/xml-data/build-dir/HYM-YF5-JOB1/source/xyformsatddtests/genresources/robottests/YFormDefinitionVersioning_Test.txt"));
		}
	...
	@Test
	public void Test_Get_YFormDefinition_With_Version()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Get_YFormDefinition_With_Version";
	...
	@Test
	public void Test_Get_YFormDefinition_With_Version_Not_Exists()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Get_YFormDefinition_With_Version_Not_Exists";
	...
	@Test
	public void Test_Get_YFormDefinition_Return_Latest_Version()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Get_YFormDefinition_Return_Latest_Version";
	...
	@Test
	public void Test_Create_YFormDefinition_With_No_Previous_Version()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Create_YFormDefinition_With_No_Previous_Version";
	...
	@Test
	public void Test_Create_YFormDefinition_With_Previous_Version()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Create_YFormDefinition_With_Previous_Version";
	...
	@Test
	public void Test_Update_YFormDefinition_Keeps_Version_Number()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Update_YFormDefinition_Keeps_Version_Number";
	...
	@Test
	public void Test_Get_YFormDefinition_With_FormDataId_Returns_The_Right_Version()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Get_YFormDefinition_With_FormDataId_Returns_The_Right_Version";
