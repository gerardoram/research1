...
@IntegrationTest
public class DynamicAttribute_Test extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("DynamicAttribute_Test-log");
			robotSettings.setOutputName("DynamicAttribute_Test-output");
			robotSettings.setReportName("DynamicAttribute_Test-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/opt/bamboo-agent/xml-data/build-dir/HYM-YF5-JOB1/source/xyformsatddtests/genresources/robottests/DynamicAttribute_Test.txt"));
		}
	...
	@Test
	public void Test_Categories_Have_All_The_YFormDefinitions_That_Assigned_To_It_And_Its_Supercategories()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Categories_Have_All_The_YFormDefinitions_That_Assigned_To_It_And_Its_Supercategories";
	...
	@Test
	public void Test_Products_Have_All_The_YFormDefinitions_That_Assigned_To_All_Of_Its_Supercategories()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Products_Have_All_The_YFormDefinitions_That_Assigned_To_All_Of_Its_Supercategories";
