...
{
	private AbstractPopulatingConverter<TitleModel, TitleData> titleConverter =
				new ConverterFactory<TitleModel, TitleData, TitlePopulator>().create(TitleData.class, new TitlePopulator());
