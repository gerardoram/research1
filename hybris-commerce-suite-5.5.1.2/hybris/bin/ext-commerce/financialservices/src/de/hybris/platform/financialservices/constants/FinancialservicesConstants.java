 ...
 *
 */
package de.hybris.platform.financialservices.constants;

/**
 * Global class for all Financialservices constants. You can add global constants for your extension into this class.
 */
public final class FinancialservicesConstants extends GeneratedFinancialservicesConstants
{
	public static final String EXTENSIONNAME = "financialservices";

	private FinancialservicesConstants()
	{
