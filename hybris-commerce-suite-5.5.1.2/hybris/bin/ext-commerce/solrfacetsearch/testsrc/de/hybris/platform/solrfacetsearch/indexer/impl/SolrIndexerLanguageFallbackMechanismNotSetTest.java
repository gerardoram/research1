...
/**
 * Test check how solr indexer behave when fallback language mechanism for {@link SolrFacetSearchConfig} is not set
 */
public class SolrIndexerLanguageFallbackMechanismNotSetTest extends SolrIndexerLanguageFallbackMechanismSetupTest
{
	@Override
	...
	public void testSearchNameAndDesriptionFor3Languages() throws Exception
	{
		...
		//product should not be found because fallback mechanism is not set
		setLanguageAndCheckSearchResults("de", PRODUCT_SHOULD_NOT_BE_FOUND);
