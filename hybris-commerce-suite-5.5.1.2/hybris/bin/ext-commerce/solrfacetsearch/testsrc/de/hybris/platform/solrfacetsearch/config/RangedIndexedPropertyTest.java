...
public class RangedIndexedPropertyTest extends AbstractSolrIntegrationTest
{
	...
	protected List<SolrIndexedPropertyModel> setUpIndexProperties()
	{
		...
		codeProperty.setFieldValueProvider("modelPropertyFieldValueProvider");
		...
		nameProperty.setFieldValueProvider("modelPropertyFieldValueProvider");
		...
		descriptionProperty.setFieldValueProvider("modelPropertyFieldValueProvider");
		...
		onlineDateProperty.setFieldValueProvider("modelPropertyFieldValueProvider");
