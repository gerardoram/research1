...
public class IndexUpdateDeleteProductTest extends AbstractSolrIntegrationTest
{
	...
	public void testUpdateNewProduct() throws Exception
	{
		try
		{
			...
			Date indexTime = indexStatisticsProvider.getLastIndexTime(solrConfig, indexedType);
			...
			indexTime = indexStatisticsProvider.getLastIndexTime(solrConfig, indexedType);
