...
public class ProductAttributesValueResolverTest extends AbstractLocalizedValueResolverTest
{
	...
	public void resolveWithSplit() throws Exception
	{
		...
		indexedProperty.getValueProviderParameters().put(ProductAttributesValueResolver.SPLIT_PARAM, Boolean.TRUE.toString());
	...
	public void resolveWithSplitRegex() throws Exception
	{
		...
		indexedProperty.getValueProviderParameters().put(ProductAttributesValueResolver.SPLIT_PARAM, Boolean.TRUE.toString());
		indexedProperty.getValueProviderParameters().put(ProductAttributesValueResolver.SPLIT_REGEX_PARAM, "/");
