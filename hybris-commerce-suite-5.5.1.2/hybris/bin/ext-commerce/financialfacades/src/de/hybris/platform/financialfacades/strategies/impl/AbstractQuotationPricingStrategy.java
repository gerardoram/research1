...
public abstract class AbstractQuotationPricingStrategy implements QuotationPricingStrategy
{
	...
	protected static String STATUS_CODE_INVALID = Config.getString("quotation.status.invalid", "INVALID_REQUEST");
	protected static String STATUS_CODE_SUCCESS = Config.getString("quotation.status.sucess", "SUCCESS");
	...
	/**
	 * Method to initialise the response data with default values.
	 * 
