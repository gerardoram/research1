...
/**
 * The class of TravelInsurancePolicyHolderDetailsPopulator.
 */
public class TravelInsurancePolicyHolderDetailsPopulator extends AbstractInsuranceDetailsPopulator
{
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(TravelInsurancePolicyHolderDetailsPopulator.class);
	protected String XPATH_TRAVELLER_HOLDER = "/form/personal-details";
	...
	public void populate(final YFormDataData yFormDataData, final InsurancePolicyData detailData)
	{
		...
		if (yFormDataData.getContent() != null)
		{
			...
			final String firstName = getTextValue(xpath, document, XPATH_TRAVELLER_HOLDER + "/first-name");
			final String lastName = getTextValue(xpath, document, XPATH_TRAVELLER_HOLDER + "/last-name");
			final String address1 = getTextValue(xpath, document, XPATH_TRAVELLER_HOLDER + "/address-line1");
			final String address2 = getTextValue(xpath, document, XPATH_TRAVELLER_HOLDER + "/address-line2");
			final String city = getTextValue(xpath, document, XPATH_TRAVELLER_HOLDER + "/address-city");
			final String postcode = getTextValue(xpath, document, XPATH_TRAVELLER_HOLDER + "/address-postcode");
			final String country = getTextValue(xpath, document, XPATH_TRAVELLER_HOLDER + "/address-country");
			...
			policyHolderDetail.setAddressCountry(country);
		}
	}
}
