...
public class EmsGrantDataMeteredConditionPopulatorTest
{
	...
	@Test
	public void zeroQuantityUsageUnit()
	{
		final EmsGrantData source = new EmsGrantData();
		final ConditionData target = new ConditionData();

		source.setMaxQuantity(0);
		source.setUsageUnit("DAY");
		populator.populate(source, target);
	...
	@Test
	public void noQuantityUsageUnit()
	{
		final EmsGrantData source = new EmsGrantData();
		final ConditionData target = new ConditionData();
	...
	@Test
	public void quantityOfMinusOneUsageUnit()
	{
		final EmsGrantData source = new EmsGrantData();
		final ConditionData target = new ConditionData();
	...
	@Test(expected = ConversionException.class)
	public void negativeQuantityUsageUnit()
	{
		final EmsGrantData source = new EmsGrantData();
		final ConditionData target = new ConditionData();
