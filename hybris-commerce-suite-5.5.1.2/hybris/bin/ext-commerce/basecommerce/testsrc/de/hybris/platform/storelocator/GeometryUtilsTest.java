...
public class GeometryUtilsTest
{
	...
	static int NUMBER_OF_LATITUDES = 359;
	static int NUMBER_OF_LONGITUDES = 179;
	private static double[][] COORDINATES = new double[NUMBER_OF_LATITUDES * NUMBER_OF_LONGITUDES][];
