...
public class GenericVariantProductValidateInterceptorTest extends AbstractCommerceServicelayerTransactionalTest
{
	...
	public void shouldSaveValidGenericVariant()
	{
		...
		final ProductModel base = createProduct("base", catalogVersion, GenericVariantProductModel._TYPECODE, unit, color, size, fit);
	...
	public void shouldPreventAssigningToAWrongMultidimensionalBaseProduct()
	{
		...
		final ProductModel shoeBase = createProduct("shoeBase", catalogVersion, GenericVariantProductModel._TYPECODE, unit, shoeColor,
				shoesNormalCategory);
		...
		final ProductModel shoeBase2 = createProduct("shoeBase2", catalogVersion, GenericVariantProductModel._TYPECODE, unit, shoeColor);
