...
@IntegrationTest
public class DefaultBundleCartFacadeIntegrationTest extends ServicelayerTest
{
	private static final Logger LOG = Logger.getLogger(DefaultBundleCartFacadeIntegrationTest.class);
	...
	{
		// importing test csv
		LOG.info("Creating data for DefaultTelcoCartFacadeIntegrationTest ...");
		...
		LOG.info("Finished data for DefaultTelcoCartFacadeIntegrationTest " + (System.currentTimeMillis() - startTime) + "ms");
