...
public class JaloPropertyNotVisibleInModelAccessorReadWriteTest
{
	...
	@InjectMocks
	private final JaloPersistanceHandler jaloPersistanceHandler = new JaloPersistanceHandler();
	@Spy
	private final BackofficeEditorAreaRenderer backofficeEditorAreaRenderer = new BackofficeEditorAreaRenderer();
	...
	{
		return new DefaultWidgetModel(new HashMap<String, Object>(), new DefaultModelValueHandler());
	}
	...
	@Test
	public void testSimpleCollectionAttribute()
	{
	...
	protected void testSkeletonNotWritable(final String attributeName, final Object value)
	{
		try
		{
			...
			final TypedValue readValue1 = jaloPropertyNotVisibleInModelAccessor
					.read(evaluationContext, productModel1, attributeName);
			...
			backofficeEditorAreaRenderer.render(null, null, productModel1, null, widgetInstanceManager);
			final TypedValue readValue2 = jaloPropertyNotVisibleInModelAccessor
					.read(evaluationContext, productModel1, attributeName);
	...
	protected void testSkeleton(final String attributeName, final Object value, final TypedValueAssertion typedValueAssertion)
	{
		try
		{
			...
			final TypedValue readValue3 = jaloPropertyNotVisibleInModelAccessor
					.read(evaluationContext, productModel1, attributeName);
			typedValueAssertion.doAssertions(readValue3);
			//render one more time the same object (refresh)
			backofficeEditorAreaRenderer.render(null, null, productModel1, null, widgetInstanceManager);
			final TypedValue readValue4 = jaloPropertyNotVisibleInModelAccessor
					.read(evaluationContext, productModel1, attributeName);
