...
public class MediaItemUploadPanelRendererTest
{
	...
	public void setUp()
	{
		...
		Mockito.when(permissionFacadeStrategy.canReadType(MediaItemUploadPanelRenderer.MEDIA_TYPE_CODE)).thenReturn(Boolean.TRUE);
	...
	protected void triggerUploadEvent(final Fileupload fileupload, final Media zkMedia) throws Exception
	{
		...
		{
			ev.onEvent(new UploadEvent(Events.ON_UPLOAD, fileupload, new Media[]
			{ zkMedia }));
		}
	}
}
