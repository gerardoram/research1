	...
	<div class="item_container">
		...
		<form:form action="${action}" method="post" commandName="loginForm">
			...
			<dl>
				...
				<formUtil:formInputBox idKey="j_username" labelKey="login.username" path="j_username" inputCSS="text"/>
				<formUtil:formPasswordBox idKey="j_password" labelKey="login.password" path="j_password" inputCSS="text password"/>
