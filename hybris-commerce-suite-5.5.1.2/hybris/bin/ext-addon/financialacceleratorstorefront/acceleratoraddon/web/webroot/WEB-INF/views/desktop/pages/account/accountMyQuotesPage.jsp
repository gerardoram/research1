        ...
        <table id="myQuotesList" class="quotesListTable">
            ...
            <c:forEach items="${quotes}" var="quote">
                ...
                <tr>
                    ...
                    <td <c:if test="${quote.quoteIsExpired}">class="expired"</c:if>><spring:theme code="text.account.myQuotes.quote.status.${quote.quoteStatus}" text="${quote.quoteStatus}" /></td>
                    <td <c:if test="${quote.quoteIsExpired}">class="expired"</c:if>>${quote.quoteExpiryDate}</td>
                    <td> <c:choose><c:when test="${!quote.quoteIsExpired}">${quote.quotePrice}<br/>
                    <c:choose>
