			              ...
			              <ul>
			                ...
			                <c:forEach items="${quotes}" begin="0" end="${maxItems - 1}" var="quote">
			                    ...
			                    <form class="retrieveQuoteForm" action="${retrieveQuoteUrl}" method="GET">
			                        ...
			                        <c:if test='${!quote.quoteIsExpired}'> <a href="" type="submit" class="retrieveBtn"></c:if>
			                            <li class="my-quotes">
			                                <div class="dataContainer">
			                                    ...
			                                    <span class="addInfos <c:if test='${quote.quoteIsExpired}'>expired</c:if>">
			                                        <c:choose>
			                                            <c:when test="${quote.quoteIsBind}">
			                        ...
			                        <c:if test='${!quote.quoteIsExpired}'> </a></c:if>
			                    </form>
			                </c:forEach>
			            </ul>
