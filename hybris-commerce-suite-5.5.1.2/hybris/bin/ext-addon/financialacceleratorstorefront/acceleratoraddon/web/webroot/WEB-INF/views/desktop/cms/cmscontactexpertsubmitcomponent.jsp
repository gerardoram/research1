...
<div class="contactExpert">
      <c:if test="${not empty param.agent}">
            ...
            <ycommerce:testId code="multicheckout_saveForm_button">
                <a class="button positive left" href="find-agent?activeCategory=${activeCategory}">
                   <spring:theme code="text.agent.contactExpert.back" text="Back"/>
                </a>
                <a id="continueBtn" class="button positive right show_processing_message" href="?sendStatus=send&agent=${param.agent}&activeCategory=${activeCategory}">
