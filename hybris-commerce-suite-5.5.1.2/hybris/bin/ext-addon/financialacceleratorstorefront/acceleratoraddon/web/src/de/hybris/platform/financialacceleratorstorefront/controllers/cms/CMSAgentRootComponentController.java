...
public class CMSAgentRootComponentController extends AbstractCMSAddOnComponentController<CMSAgentRootComponentModel>
{
	...
	protected String defineActiveCategory(final HttpServletRequest request, final List<CategoryData> categories)
	{
        ...
        return request.getAttribute("activeCategory")!=null
            ? request.getAttribute("activeCategory").toString()
            : !categories.isEmpty()
