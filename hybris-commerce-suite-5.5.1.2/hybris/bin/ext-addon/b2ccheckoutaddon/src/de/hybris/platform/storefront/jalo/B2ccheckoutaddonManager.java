...
import de.hybris.platform.storefront.constants.B2ccheckoutaddonConstants;



/**
 * This is the extension manager of the B2ccheckoutaddon extension.
 */
public class B2ccheckoutaddonManager extends GeneratedB2ccheckoutaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2ccheckoutaddonManager.class.getName());
	 ...
	 */
	public static B2ccheckoutaddonManager getInstance()
	{
		return (B2ccheckoutaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				B2ccheckoutaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2ccheckoutaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2ccheckoutaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2ccheckoutaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2ccheckoutaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
