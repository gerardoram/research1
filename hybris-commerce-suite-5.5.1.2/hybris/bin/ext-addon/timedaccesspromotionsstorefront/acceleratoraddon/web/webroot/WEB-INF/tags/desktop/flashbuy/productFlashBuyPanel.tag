...
<div class="flashbuy-frame">
	<div class="flashbuy-line">
		...
		<c:choose>
			...
			<c:otherwise>
				...
				<span class="flashbuy-label secondContent"> ${product.specialPromotions[0].availableUnitsPerProduct} </span>
	...
	<div class="flashbuy-line">
		...
		<del class="secondContent"> <format:fromPrice priceData="${product.price}" /> </del>
	</div>
