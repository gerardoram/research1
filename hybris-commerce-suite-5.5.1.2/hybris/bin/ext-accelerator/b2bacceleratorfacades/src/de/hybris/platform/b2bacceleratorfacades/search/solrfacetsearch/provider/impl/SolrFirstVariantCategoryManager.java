 ...
 *  
 */
package de.hybris.platform.b2bacceleratorfacades.search.solrfacetsearch.provider.impl;
...
/**
 * Class to process {@link de.hybris.platform.b2bacceleratorfacades.product.data.SolrFirstVariantCategoryEntryData} operations.
 */
@Deprecated
public class SolrFirstVariantCategoryManager
{
	 ...
	 *           Sorted pairs of {@link de.hybris.platform.b2b.model.VariantValueCategoryModel} and {@link de.hybris.platform.b2b.model.GenericVariantProductModel}.code.
	...
	/**
	 * Generate a list of {@link de.hybris.platform.b2bacceleratorfacades.product.data.SolrFirstVariantCategoryEntryData} based on a Solr property String that holds the first
	 * category name list.
	 *
	 * @param solrProperty
	 *           The first category name list.
	 * @return List of {@link de.hybris.platform.b2bacceleratorfacades.product.data.SolrFirstVariantCategoryEntryData};
	 */
