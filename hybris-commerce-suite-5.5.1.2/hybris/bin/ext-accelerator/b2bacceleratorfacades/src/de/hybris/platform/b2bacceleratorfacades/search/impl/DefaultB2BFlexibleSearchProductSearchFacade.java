...
import de.hybris.platform.b2bacceleratorfacades.search.converters.impl.DefaultB2BFlexibleSearchConverter;
		...
		SearchFacade<ProductData, ProductSearchStateData>
{
	...
	public DefaultB2BFlexibleSearchConverter getFlexibleSearchConverter()
	{
		return (DefaultB2BFlexibleSearchConverter) flexibleSearchConverter;
	}
