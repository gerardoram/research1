 ...
 *  
 */
package de.hybris.platform.b2bacceleratorfacades.product.variant.populators;
		...
		Populator<SOURCE, TARGET>
{
	...
	private StockThresholdPopulator stockThresholdPopulator;
			...
			throws ConversionException
	{
		...
		stockThresholdPopulator.populate(variantProductModel, stock);

		variantOptionData.setStock(stock);
	}

	public StockThresholdPopulator getStockThresholdPopulator()
	{
		return stockThresholdPopulator;
	}

	@Required
	public void setStockThresholdPopulator(final StockThresholdPopulator stockThresholdPopulator)
	{
		this.stockThresholdPopulator = stockThresholdPopulator;
	}
