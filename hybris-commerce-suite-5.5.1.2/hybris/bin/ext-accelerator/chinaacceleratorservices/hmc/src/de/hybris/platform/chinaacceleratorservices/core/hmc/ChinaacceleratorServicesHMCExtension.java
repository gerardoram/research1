 ...
 *
 */
package de.hybris.platform.chinaacceleratorservices.core.hmc;
...
/**
 * Provides necessary meta information about the chinaacceleratorservices hmc extension.
 *
 *
 * @version ExtGen v4.1
 */
public class ChinaacceleratorServicesHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(ChinaacceleratorServicesHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "de.hybris.platform.chinaacceleratorservices.core.hmc.locales";
