...
public class DefaultCmsCacheService implements CmsCacheService
{
	...
	private static String CMS_CACHE_ENABLED_KEY = "cms.cache.enabled";
	private static String CMS_CACHE_USE_DEFAULT_FALLBACK_KEY = "cms.cache.use.default.fallback";
	...
	protected final Supplier<Boolean> useCache = Suppliers.memoizeWithExpiration(new Supplier<Boolean>()
	{
		@Override
		public Boolean get()
		{
