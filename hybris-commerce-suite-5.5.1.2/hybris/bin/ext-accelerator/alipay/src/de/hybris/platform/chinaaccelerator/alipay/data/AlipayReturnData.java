...
public class AlipayReturnData
{
	...
	/**
	 * @param exterface the exterface to set
	 */
	...
	/**
	 * @return the bank_seq_no
	 */
	public String getBank_seq_no() {
		return bank_seq_no;
	}
	/**
	 * @param bank_seq_no the bank_seq_no to set
	 */
	...
	/**
	 * @param extra_common_param the extra_common_param to set
	 */
